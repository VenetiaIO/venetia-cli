(function () {
    ...
    var adyen = (window.adyen = window.adyen || {}),
      cardTypes = (function () {
        ...
        function checkCardNumber() {
          var a = checkCardNumber.arguments;
  ...
  (function (root, fnDefine) {
    ...
    function bnpDivRemTo(n, h, g) {
      ...
      while (--s >= 0) {
        var c =
          g[--u] == b ? this.DM : Math.floor(g[u] * A + (g[u - 1] + x) * z);
    ...
    sjcl.bitArray = {
      ...
      P: function (g, f, j, i) {
        ...
        g = sjcl.bitArray.getPartial(h);
        i.push(
          sjcl.bitArray.partial((f + g) & 31, 32 < f + g ? j : i.pop(), 1)
        );
        return i;
      },
      l: function (d, c) {
    ...
    sjcl.misc.hmac.prototype.encrypt = sjcl.misc.hmac.prototype.mac = function (
      ...
      this.Q &&
        q(
          new sjcl.exception.invalid("encrypt on already updated hmac called!")
        );
      this.update(b);
    ...
    (function (document, window) {
      if (document && window && document.getElementsByTagName) {
                ...
                case "select":
                  for (var e = 0; e < l.options.length; e++) {
                    if (l.options[e].selected) {
                      ...
                      i[n][i[n].length] = encodeURIComponent(
                        l.options[e].value
                      );
                    }
                  }
        ...
        function dfGetProp() {
          ...
          try {
            ...
            try {
              ...
              E.timeZone = padString(
                calculateMd5_b64(C + "**" + D),
                s.timeZone
              );
            } catch (u) {
        ...
        function md5_cmn(a, j, k, m, b, i) {
          return md5_safe_add(
            md5_bit_rol(
              md5_safe_add(md5_safe_add(j, a), md5_safe_add(m, i)),
              b
            ),
            k
          );
        ...
        var PluginDetect = {
          ...
          initScript: function () {
            ...
            i.verGecko = i.isGecko
              ? i.formatNum(
                  /rv\s*\:\s*([\.\,\d]+)/i.test(e) ? RegExp.$1 : "0.9"
                )
              : null;
            ...
            getVersion: function (a) {
              ...
              if (!b.isIE) {
                if (b.hasMimeType(d.mimeType)) {
                  c =
                    b.OS != 3
                      ? b.findNavPlugin("QuickTime.*Plug-?in", 0)
                      : null;
                  if (c && c.name) {
                    e = b.getNum(c.name);
                  }
          ...
          realplayer: {
            ...
            convertNum: function (h, d, c) {
              ...
              if (
                e.compare(b.slice(0, Math.min(d[0].length, b.length)), d[0]) !=
                0
              ) {
                return g;
              }
    ...
    var EncryptedForm = function (element, key, options) {
      ...
      if (
        "form" !== (element.nodeName || element.tagName || "").toLowerCase()
      ) {
        throw new Error("Expected target element to be a HTML Form element");
      }
      ...
      addValidations: function () {
        ...
        for (; c-- > 0; ) {
          ...
          if (fieldName === "number") {
            ...
            handlers.luhnHandler({ target: element, isInitializing: true });
          } else {
            if (fieldName === "cvc") {
              handlers.cvcHandler =
                handlers.cvcHandler ||
              ...
              handlers.cvcHandler({ target: element, isInitializing: true });
            } else {
        ...
        for (; c-- > 0; ) {
          ...
          if (!element || !element.getAttribute) {
            ...
            if (element.getAttribute(this.fieldNameAttribute) === "number") {
              ...
              updateCardTypeDetection({ target: element });
            }
          }
        }
      },
  ...
  if (typeof adyen.encrypt.createEncryptedForm === "function") {
    (function () {
      var key =
        "10001|";
