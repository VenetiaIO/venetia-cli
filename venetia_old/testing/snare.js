window = {}
document = {
    documentURI:'https://www.footlocker.co.uk/en/checkout-overview?SynchronizerToken=f6d07df8a0aed8d78fb235bc3867782f3f3b1bb4aedf4843a848c22d80c7c73a',
    URL:'https://www.footlocker.co.uk/en/checkout-overview?SynchronizerToken=f6d07df8a0aed8d78fb235bc3867782f3f3b1bb4aedf4843a848c22d80c7c73a',
    readyState:'complete'
}
...
function __if_b(_if_gp, _if_gq) {
  ...
  if (_if_gq instanceof Error && typeof _if_gq.description != "undefined")
    _i_b = _if_gq.description;
...
if (typeof window.io_install_stm != "boolean")
  window.io_install_stm = _i_z._i_fu;
if (typeof window.io_install_flash != "boolean")
  window.io_install_flash = _i_z._i_fw;
if (typeof window.io_exclude_stm != "number")
  window.io_exclude_stm = _i_z._i_fv;
if (window.io_stm_cab_url === undefined)
  window.io_stm_cab_url =
    _i_o.__if_ap("aHR0cHM6Ly9tcHNuYXJlLmllc25hcmUuY29tLw==") + "/StmOCX.cab";
if (window.io_install_stm_error_handler === undefined)
  window.io_install_stm_error_handler = _i_z._i_fx;
if (window.io_flash_needs_update_handler === undefined)
  window.io_flash_needs_update_handler = _i_z._i_fy;
if (typeof window.io_enable_rip != "boolean") window.io_enable_rip = _i_z._i_fz;
if (window.io_flash_blacklist === undefined)
  window.io_flash_blacklist = _i_z._i_ga;
if (window.io_flash_whitelist === undefined)
  window.io_flash_whitelist = _i_z._i_gb;
if (window.io_min_flash_in_firefox_version === undefined)
  window.io_min_flash_in_firefox_version = _i_z._i_gc;
if (window.io_min_flash_in_firefox_linux_version === undefined)
  window.io_min_flash_in_firefox_linux_version = _i_z._i_gd;
if (window.io_min_flash_version === undefined)
  window.io_min_flash_version = _i_z._i_ge;
var _i_aa = {
  getElementById: function (_if_gw) {
    ...
    if (document.all && document.getElementsByName) {
      ...
      for (var _i_g = 0; _i_g < _i_ab.length; _i_g++)
        if (_i_ab[_i_g]._i_dv && _i_ab[_i_g]._i_dv == _if_gw)
          return _i_ab[_i_g];
    }
...
__if_d.prototype = {
  ...
  __if_il: function () {
    ...
    for (_i_g = 0; _i_g < _i_dd.length; _i_g++) {
      for (
        _i_bl = 0;
        this.attributes && _i_bl < this.attributes.length;
        _i_bl++
      ) {
        if (
          this.attributes[_i_bl]
            .toUpperCase()
            .search(_i_dd[_i_g].toUpperCase()) >= 0
        ) {
    ...
    for (_i_g = 0; _i_g < _i_dh.length; _i_g++) {
      for (
        ...
        if (
          this.attributes[_i_bl]
            .toUpperCase()
            .search(_i_dh[_i_g].toUpperCase()) >= 0
        ) {
...
var io_adp = {
  ...
  __if_op: function () {
    ...
    // var _i_dn =
    //   '<object id="stm" classid="clsid:7A0D1738-10EA-47FF-92BE-4E137B5BE1A4" height="1" width="1" onreadystatechange="io_adp.readyStateChangeHandler()"';
    // if (window.io_install_stm) {
    //   _i_dn +=
        // ' codebase="' +
        // window.io_stm_cab_url +
        // '" onError="io_adp.errorHandler()"';
    // }
    // _i_dn += "></object>";
  ...
  __if_pv: function () {
    ...
    return (
      (_i_dq.__if_nm() && window.io_exclude_stm & _i_dp) ||
      (_i_dq.__if_mk() && window.io_exclude_stm & BM_XP) ||
      (_i_dq.__if_kj() && window.io_exclude_stm & BM_CE) ||
      (_i_dq.__if_lj() && window.io_exclude_stm & BM_VISTA)
    );
  },
};
...
var _i_dt = {
  __if_rd: function (_i_go, _if_hh) {
    ...
    _i_cr.__if_fc(
      "WDBERROR",
      typeof _i_du._if_gp != "undefined"
        ? _i_du._if_gp
        : _i_du.toString() + _i_du.code
    );
  },
  __if_sm: function (_i_go, _i_e, _i_dr) {
    if (typeof _i_dr != "undefined" && _i_dr)
      _i_go.executeSql(
  ...
  __if_op: function () {
    ...
    try {
      if (window.localStorage) {
        ...
        if (_i_dv == null) {
          if (typeof this._if_hn != "undefined" && this._if_hn)
            window.localStorage.setItem(this._if_hg, this._if_hn);
...
function iov_fl_get_value(_if_hm, _i_gn) {
  for (var _i_g = 0; _i_g < io_cm.length; _i_g++) {
    if (typeof _i_gn != "undefined" && io_cm[_i_g]._i_gn == _i_gn) {
      ...
      if (_if_hm == "rip" && window.io_enable_rip)
        return _i_o.__if_ap("bXBzbmFyZS5pZXNuYXJlLmNvbQ==");
    }
  }
  return "";
}
...
__if_g.prototype = {
  __if_wu: function () {
    if (
      ...
      (navigator.plugins.length > 0 || navigator.plugins["Shockwave Flash"])
    ) {
      if (
        navigator.plugins["Shockwave Flash 2.0"] ||
        navigator.plugins["Shockwave Flash"]
      ) {
        var _i_eb = navigator.plugins["Shockwave Flash 2.0"]
          ? "Shockwave Flash 2.0"
          : "Shockwave Flash";
        var _i_ec = navigator.plugins[_i_eb].version
          ? navigator.plugins[_i_eb].version
          : "";
        var _i_ed = "";
        if (navigator.plugins[_i_eb] && navigator.plugins[_i_eb].description) {
          ...
          var _i_eh =
            _i_ee[3] !== "" ? _i_ee[3].split("r") : _i_ee[4].split("r");
  ...
  __if_yi: function (_i_dv) {
    if (window.io_enable_rip && !this._i_gl)
  ...
  __if_zx: function () {
    ...
    return (
      ...
      _i_el.test(document.readyState)
    );
  },
  __if_abn: function (_i_ev) {
    ...
    var _i_em = new Array() && "32.0.0.238,32.0.0.207,11.2.202.644".split(",");
    ("");
    if (
      window.io_flash_blacklist &&
      window.io_flash_blacklist.constructor === Array
    ) {
  ...
  __if_ade: function (_i_ev) {
    ...
    var _i_en = window.io_min_flash_in_firefox_version || "32.0.0.255";
    var _i_eo = new Array() && "32.0.0.255".split(",");
    ("");
    if (
      window.io_flash_whitelist &&
      window.io_flash_whitelist.constructor === Array
    ) {
    ...
    for (var _i_g = 0; _i_g < navigator.plugins.length; _i_g++) {
      ...
      if (_i_ep.filename === "libflashplayer.so") {
        _i_en = window.io_min_flash_in_firefox_linux_version || "32.0.0.255";
      }
    }
  ...
  __if_op: function () {
    ...
    if (
      ...
      (navigator.userAgent.toLowerCase().indexOf("firefox") > -1 &&
        !this.__if_ade(_i_ev)) ||
      parseFloat(_i_ev) < _i_eu
    ) {
      try {
        if (window.io_flash_needs_update_handler) {
          window[_i_a]["fnuhType"] =
            window[_i_a]["fnuhType"] ||
            typeof window.io_flash_needs_update_handler;
    ...
    _i_ex +=
      ...
      this._i_gn +
      '" swliveconnect="true" allowscriptaccess="always" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"';
    _i_ex += "/></object>";
...
var io_dp = {
  ...
  __if_op: function () {
    ...
    try {
      ...
      _i_cr.__if_fc("JREFRR", document.URL);
    } catch (e) {
      console.log(e)
...
try {
  ...
  var _i_fo = new __if_g(
    _i_o.__if_ap("aHR0cHM6Ly9tcHNuYXJlLmllc25hcmUuY29tLw==") + "stmgwb2.swf",
    __if_h() ? "" : "6Cnjb0dNc7c00Iwl5M23SKuUAaHxHAS+Ir/XDwW6ZbU="
  );
  io_cm.push(_i_fm, _i_fn, io_adp, _i_fo);
  if (__if_h())
    _i_cr.__if_fc("FLRTD", "6Cnjb0dNc7c00Iwl5M23SKuUAaHxHAS+Ir/XDwW6ZbU=");
  else
    _i_fm._if_hn = _i_fn._if_hn =
      "6Cnjb0dNc7c00Iwl5M23SKuUAaHxHAS+Ir/XDwW6ZbU=";
  try {
    var _i_dl = document.getElementsByTagName("head")[0];
