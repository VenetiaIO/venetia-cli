...
(156,23460-23467): run-time error JS1019: Can't have 'break' outside of loop: break a
 */
/*
 *
...
(function (root, fnDefine) {
  ...
  sjcl.hash.sha256 = function (b) {
    this.b[0] || this.D();
    b
      ? ((this.r = b.r.slice(0)), (this.o = b.o.slice(0)), (this.h = b.h))
      : this.reset();
  };
  ...
  sjcl.mode.ccm = {
    ...
    L: function (s, r, p, o, n, m) {
      ...
      if (o.length) {
        ...
        65279 >= p
          ? (k = [j.partial(16, p)])
          : 4294967295 >= p && (k = j.concat([j.partial(16, 65534)], [p]));
        k = j.concat(k, o);
  ...
  sjcl.mode.ocb2 = {
    ...
    pmac: function (j, i) {
      ...
      p = i.slice(p);
      128 > n.bitLength(p) &&
        ((k = m(k, o(k))), (p = n.concat(p, [-2147483648, 0, 0, 0])));
      l = m(l, p);
  ...
  sjcl.mode.gcm = {
    ...
    decrypt: function (j, i, p, o, n) {
      ...
      o = o || [];
      n <= k
        ? ((i = l.bitSlice(m, k - n)), (m = l.bitSlice(m, 0, k - n)))
        : ((i = m), (m = []));
    ...
    Z: function (j, i) {
      ...
      m = i.slice(0);
      for (p = 0; 128 > p; p++) {
        (o = 0 !== (j[Math.floor(p / 32)] & (1 << (31 - (p % 32))))) &&
          (n = k(n, m));
        l = 0 !== (m[3] & 1);
        for (o = 3; 0 < o; o--) {
  ...
  sjcl.prng.prototype = {
    randomWords: function (i, h) {
      ...
      if (m & this.u) {
        ...
        for (
          m = 0;
          4 > m && !((this.f[m] = (this.f[m] + 1) | 0), this.f[m]);
          m++
        ) {}
      }
      for (m = 0; m < i; m += 4) {
    ...
    addEntropy: function (s, r, p) {
      ...
      this.d += r;
      j === this.m &&
        (this.isReady() !== this.m && C("seeded", Math.max(this.j, this.d)),
        C("progress", this.getProgress()));
    },
    isReady: function (b) {
      b = this.I[b !== t ? b : this.B];
      return this.j && this.j >= b
        ? this.i[0] > this.R && new Date().valueOf() > this.O
          ? this.u | this.t
          : this.t
        : this.d >= b
        ? this.u | this.m
    ...
    Y: function (i, h, n, m) {
      ...
      "string" === typeof i
        ...
        : sjcl.ecc &&
          ...
          ((j = i.kem()), (k.kemtag = j.tag), (i = j.key.slice(0, k.ks / 32)));
    ...
    X: function (i, h, n, m) {
      ...
      "string" === typeof i
        ...
        : sjcl.ecc &&
          ...
          (i = i.unkem(sjcl.codec.base64.toBits(h.kemtag)).slice(0, h.ks / 32));
      ...
      for (e in f) {
        if (f.hasOwnProperty(e)) {
          switch (
            (e.match(/^[a-z0-9]+$/i) ||
              q(
                new sjcl.exception.invalid("json encode: invalid property name")
              ),
            (h += g + '"' + e + '":'),
            (g = ","),
            typeof f[e])
    ...
    function c(e, f, g, d) {
      if (typeof e.addEventListener === "function") {
        ...
        if (e.attachEvent) {
          ...
          throw new Error(
            encrypt.errors.UNABLETOBIND + ": Unable to bind " + f + "-event"
          );
        }
      }
    }
  ...
  (function (document, window) {
    if (
      ...
      _.X = function (d, h, g, f) {
        f = new (window.ActiveXObject ? ActiveXObject : XMLHttpRequest)(
          "Microsoft.XMLHTTP"
        );
      ...
      _.R = function (b) {
        "\v" == "v" ||
        document.documentElement.style.scrollbar3dLightColor != undefined
          ? setTimeout(b, 0)
          : _.E(document, "DOMContentLoaded", b);
      };
      function dfGetPlug() {
        var u = "";
        var q = 0;
      ...
      function dfGetProp() {
        ...
        try {
          ...
          E.superCookies =
            padString(
              calculateMd5_b64(dfGetDS()),
              Math.floor(s.superCookies / 2)
            ) +
            padString(
              calculateMd5_b64(dfGetIEUD()),
              Math.floor(s.superCookies / 2)
            );
          E.userAgent = padString(
            calculateMd5_b64(navigator.userAgent),
            s.userAgent
          );
          var v = "";
          var y = 0;
          ...
          E.canvas = padString(
            calculateMd5_b64(dfCanvasFingerprint()),
            s.canvas
          );
          E.cpuClass = navigator.cpuClass
            ? padString(calculateMd5_b64(navigator.cpuClass), s.cpuClass)
            : padString("", s.cpuClass);
          E.platform = navigator.platform
            ? padString(calculateMd5_b64(navigator.platform), s.platform)
            : padString("", s.platform);
          E.doNotTrack = navigator.doNotTrack
            ? padString(calculateMd5_b64(navigator.doNotTrack), s.doNotTrack)
            : padString("", s.doNotTrack);
      ...
      function md5_cmn(a, j, k, m, b, i) {
        return md5_safe_add(
          md5_bit_rol(md5_safe_add(md5_safe_add(j, a), md5_safe_add(m, i)), b),
          k
        );
      }
      ...
      var PluginDetect = {
        ...
        getNum: function (d, a) {
          var b = this,
            c = b.isStrNum(d)
              ? (b.isDefined(a) ? new RegExp(a) : b.getNumRegx).exec(d)
              : null;
          return c ? c[0] : null;
        },
        ...
        findNavPlugin: function (d, k, h) {
          ...
          for (m = 0; m < f.length; m++) {
            ...
            if (
              (a.test(e) &&
                (!j || j.test(RegExp.leftContext + RegExp.rightContext))) ||
              (a.test(g) &&
                (!j || j.test(RegExp.leftContext + RegExp.rightContext)))
            ) {
        ...
        getMimeEnabledPlugin: function (e, d) {
          ...
          if (
            (f = c.hasMimeType(e)) &&
            (f = f.enabledPlugin) &&
            (a.test(f.description || b) || a.test(f.name || b))
          ) {
            return f;
          }
          return 0;
        ...
        initScript: function () {
            ...
            var m = (function (u, ae) {
              ...
              var ah = {
                extend: function (z, w) {
                  for (var y in w) {
                    if (
                      "browser cpu device engine os".indexOf(y) !== -1 &&
                      w[y].length % 2 === 0
                    ) {
                      z[y] = w[y].concat(z[y]);
                    }
                          ...
                          if (typeof H === ag && H.length > 0) {
                            if (H.length == 2) {
                              ...
                              if (H.length == 3) {
                                ...
                                if (H.length == 4) {
                                  w[H[0]] = B
                                    ? H[3].call(this, B.replace(H[1], H[2]))
                                    : ae;
                                }
                              }
                            }
              ...
              var S = function (z, w) {
                ...
                var y =
                  z ||
                  (u && u.navigator && u.navigator.userAgent
          ...
          if (i.isIE) {
            ...
            i.head = i.isDefined(document.getElementsByTagName)
              ? document.getElementsByTagName("head")[0]
              : null;
          }
          i.isGecko = /Gecko/i.test(d) && /Gecko\s*\/\s*\d/i.test(e);
          i.verGecko = i.isGecko
            ? i.formatNum(/rv\s*\:\s*([\.\,\d]+)/i.test(e) ? RegExp.$1 : "0.9")
            : null;
          ...
          i.verOpera =
            i.isOpera && (/Version\s*\/\s*(\d+\.?\d*)/i.test(e) || 1)
              ? parseFloat(RegExp.$1, 10)
              : null;
        ...
        fPush: function (c, b) {
          ...
          if (
            a.isArray(b) &&
            (a.isFunc(c) || (a.isArray(c) && c.length > 0 && a.isFunc(c[0])))
          ) {
            b.push(c);
          }
        },
        ...
        codebaseSearch: function (h, b) {
          ...
          if (
            h.BIfuncs &&
            h.BIfuncs.length &&
            h.BIfuncs[h.BIfuncs.length - 1] !== null
          ) {
        ...
        onDoneEmptyDiv: function () {
          ...
          if (
            a.WLfuncs &&
            a.WLfuncs.length &&
            a.WLfuncs[a.WLfuncs.length - 1] !== null
          ) {
            return;
          }
          for (b in a) {
        ...
        getTagStatus: function (f, m, g, h) {
          ...
          try {
            if (
              d == i.pluginSize &&
              (!i.isIE || i.getDOMobj(f).readyState == 4)
            ) {
        ...
        insertHTML: function (k, f, m, b, D) {
          ...
          if (q.div && q.div.parentNode) {
            ...
            if (
              ...
              !(q.isGecko && q.compareNums(q.verGecko, "1,5,0,0") < 0)
            ) {
          ...
          getVersion: function (a) {
            ...
            if (!b.isIE) {
              if (b.hasMimeType(d.mimeType)) {
                c =
                  b.OS != 3 ? b.findNavPlugin("QuickTime.*Plug-?in", 0) : null;
                if (c && c.name) {
                  e = b.getNum(c.name);
                }
              }
              ...
              if (!e) {
                ...
                if (c && c.QuickTimeVersion) {
                  ...
                  e =
                    parseInt(e.charAt(0), 16) +
                    "." +
                    parseInt(e.charAt(1), 16) +
                    "." +
                    parseInt(e.charAt(2), 16);
                }
              }
            }
          ...
          CDBASE2VER: function (d) {
            ...
            if (d) {
              ...
              for (f = 0; f < e.length; f++) {
                if (
                  e[f] &&
                  a.compareNums(d, e[f]) < 0 &&
                  b[f] &&
                  a.compareNums(d, b[f]) >= 0 &&
                  c.cdbase2ver[f]
                ) {
          ...
          getVersion: function () {
            ...
            if (!c.isIE) {
              if (c.hasMimeType(f.mimeType)) {
                d =
                  c.findNavPlugin("Windows\\s*Media.*Plug-?in", 0, "Totem") ||
                  c.findNavPlugin(
                    "Flip4Mac.*Windows\\s*Media.*Plug-?in",
                    0,
                    "Totem"
                  );
                b =
                  c.isGecko &&
                  c.compareNums(c.verGecko, c.formatNum("1.8")) < 0;
                b = b || (c.isOpera && c.verOpera < 10);
                if (
                  !b &&
                  c.getMimeEnabledPlugin(
                    f.mimeType[2],
                    "Windows\\s*Media.*Firefox.*Plug-?in"
                  )
                ) {
                  a = c.getDOMobj(
                    c.insertHTML(
                      "object",
                      ["type", f.mimeType[2], "data", ""],
                      ["src", ""],
                      "",
                      f
                    )
          ...
          getVersion: function () {
            ...
            if (!u.isIE) {
              ...
              if (u.hasMimeType(K.mimeType)) {
                b =
                  u.isGecko &&
                  u.compareNums(u.verGecko, u.formatNum("1.6")) <= 0;
                if (u.isGecko && b) {
                  e = false;
                }
        ...
        realplayer: {
          ...
          convertNum: function (h, d, c) {
            ...
            if (
              e.compare(b.slice(0, Math.min(d[0].length, b.length)), d[0]) != 0
            ) {
              return g;
            }
                ...
                if (o) {
                  ...
                  if (g.OS == 1 && c) {
                    ...
                    if (r.compare(i, [6, 0, 12, 200]) < 0) {
                      ...
                      if (
                        r.compare(i, [6, 0, 12, 1739]) <= 0 &&
                        r.compare(i, [6, 0, 12, 857]) >= 0
                      ) {
                        L = false;
                      }
                    }
                  ...
                  if (g.OS <= 2) {
                    if (
                      g.isGecko &&
                      g.compareNums(g.verGecko, g.formatNum("1,8")) < 0
                    ) {
                      j = 0;
                    }
                    if (g.isChrome) {
  ...
  function addEvent(element, event, callback, capture) {
    if (typeof element.addEventListener === "function") {
      ...
      throw new Error(
        encrypt.errors.UNABLETOBIND + ": Unable to bind " + event + "-event"
      );
    }
  }
  ...
  EncryptedForm.prototype = {
      ...
      for (; c-- > 0; ) {
        ...
        if (!element || !element.getAttribute) {
          ...
          handlers.luhnHandler =
            handlers.luhnHandler ||
            validations.createChangeHandler(cse, "number", true);
          ...
          handlers.cvcHandler =
            handlers.cvcHandler ||
            validations.createChangeHandler(cse, "cvc", true);
          ...
          element.getAttribute(this.fieldNameAttribute) === "expiryYear"
        ) {
          handlers.expiryYearHandler =
            handlers.expiryYearHandler ||
            validations.createChangeHandler(cse, "year", true);
          ...
          element.getAttribute(this.fieldNameAttribute) === "expiryMonth"
        ) {
          handlers.expiryMonthHandler =
            handlers.expiryMonthHandler ||
            validations.createChangeHandler(cse, "month", true);
          ...
          element.getAttribute(this.fieldNameAttribute) === "holderName"
        ) {
          handlers.holderNameHandler =
            handlers.holderNameHandler ||
            validations.createChangeHandler(cse, "holderName", false);
    ...
    addCardTypeDetection: function (cardTypeElement) {
      if (
        ...
        return (
          window.console &&
          window.console.warn("[CSE] Card type detection not available")
        );
      }
    ...
    toggleSubmit: function () {
      ...
      enabled =
        valid === true ||
        (this.options && this.options.submitButtonAlwaysEnabled === true);
...
$(function () {
  if ($("#completeOrderPayment").length != 0) {
    $("#completeOrderPayment").on("click", function (e) {
      var $theButton = $("#completeOrderPayment");
      if ($theButton.prop("disabled") == true) {
        e.preventDefault();
        return false;
      }
      if ($("#fw100Iagree") && $("#fw100Iagree").prop("checked") == false) {
        alert($(this).data("terms"));
        e.preventDefault();
        return;
      } else if ($("#tbxExport") && $("#tbxExport").prop("checked") == false) {
        alert($(this).data("exterms"));
        e.preventDefault();
        return;
      }
      ...
      var luhnChk = (function (a) {
        return function (c) {
          for (var l = c.length, b = 1, s = 0, v; l; )
            (v = parseInt(c.charAt(--l), 10)), (s += (b ^= 1) ? a[v] : v);
          return s && 0 === s % 10;
        };
      })([0, 2, 4, 6, 8, 1, 3, 5, 7, 9]);
      ...
      switch (selectedPaymentOption) {
        case "newcard":
          ...
          if ($("#CardType").val().length == 0) {
            $("#newCardTypeRequiredError").removeClass("hide");
            stopPost = true;
          }
          if ($("#adyen-encrypted-form-holder-name").val().length == 0) {
            $("#newCardHolderNameRequiredError").removeClass("hide");
            stopPost = true;
          } else if (
            !$("#adyen-encrypted-form-holder-name")
              .val()
              .match(new RegExp("^[a-zA-Z0-9]+[a-zA-Z0-9 '-]*$"))
          ) {
            $("#newCardHolderNameInvalidError").removeClass("hide");
            stopPost = true;
          }
          if ($("#adyen-encrypted-form-number").val().length == 0) {
            $("#newCardCardNumberRequiredError").removeClass("hide");
            stopPost = true;
          } else if (
            $("#adyen-encrypted-form-number").val().length < 12 ||
            !$("#adyen-encrypted-form-number")
              .val()
              .match(new RegExp("^[0-9]+$")) ||
            !luhnChk($("#adyen-encrypted-form-number").val())
          ) {
            $("#newCardCardNumberInvalidError").removeClass("hide");
            stopPost = true;
          }
          if (
            $("#adyen-encrypted-form-expiry-month").val().length == 0 ||
            $("#adyen-encrypted-form-expiry-year").val().length == 0
          ) {
            $("#newCardExpiryRequiredError").removeClass("hide");
            stopPost = true;
          } else {
            if (
              new Date() >
              ...
              $("#newCardExpiryPastError").removeClass("hide");
              stopPost = true;
            }
          }
          if (
            $("#detail-newcard #adyen-encrypted-form-cvc").val().length == 0
          ) {
            $("#detail-newcard #newCardCv2RequiredError").removeClass("hide");
            stopPost = true;
          } else {
            if (
              $("#detail-newcard #adyen-encrypted-form-cvc").val().length < 3 ||
              $("#detail-newcard #adyen-encrypted-form-cvc").val().length > 4 ||
              !$("#detail-newcard #adyen-encrypted-form-cvc")
                .val()
                .match(new RegExp("^[0-9]+$"))
            ) {
              $("#detail-newcard #newCardCv2Length3Error").removeClass("hide");
              stopPost = true;
            }
          }
          break;
        case "existingCard":
          if ($("#existingCardsDdl").val() == -1) {
            $("#existingCardsOptionError").removeClass("hide");
            stopPost = true;
          }
          if ($(".existingcard:visible .existingCV2 input").length) {
            if (
              $(".existingcard:visible .existingCV2 input").val().length < 3 ||
              $(".existingcard:visible .existingCV2 input").val().length > 4 ||
              !$(".existingcard:visible .existingCV2 input")
                .val()
                .match(new RegExp("^[0-9]+$"))
            ) {
              $(".existingcard #newCardCv2Length3Error").removeClass("hide");
              stopPost = true;
            }
          }
          break;
        case "sepadirectdebit":
          if ($("#sepaiban").val().length == 0) {
            $("#sepaibanError").removeClass("hide");
            stopPost = true;
          }
          if ($("#sepaowner").val().length == 0) {
            $("#sepaownerError").removeClass("hide");
            stopPost = true;
          }
          break;
      }
      ...
      if (stopPost) {
        ...
        // Disable the button, change to say "processing"
        var theText = "Processing...";
        var transText = $theButton.attr("data-processing");
        if (transText != "" && transText != undefined && transText != null) {
          theText = transText;
        }
        $theButton
          .html(theText)
        ...
        $("#content.checkout").fadeTo(0, 0.3);
        $("#pleaseWait.button--loading").show();
        // $('#adyen-encrypted-form').submit(); // unnecessary explicit submit here :(
