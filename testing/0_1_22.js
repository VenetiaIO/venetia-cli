...
(function (root, fnDefine) {
    ...
    try {
      ...
      window.btoa = function (h) {
        ...
        for (g = 0, e = h.length; g < e; g += 3) {
          ...
          var m = g + 2 < e ? j & 63 : 64;
          f += a.charAt(d) + a.charAt(c) + a.charAt(o) + a.charAt(m);
        }
        return f;
      };
    } catch (b) {}
    ...
    if (window && (window.attachEvent || window.addEventListener)) {
      c(window, "focus", function () {
        ...
        if (window.location && typeof window.location.href == "string") {
          evLog("set", "referrer", window.location.href);
        }
      });
  ...
  validations.generationTimeValidDate = function (val) {
    ...
    return m &&
      ("" + m[1]).match(/^20[1-9][0-9]$/) &&
      ("" + m[2]).match(/^(12|11|10|0[1-9])$/) &&
      ("" + m[3]).match(/^(31|30|20|10|[012][1-9])$/)
      ? true
      : false;
  };
  validations.generationTimeValidTime = function (val) {
    ...
    return withoutZoneAndMs.match(
      /^[012345][0-9]:?[012345][0-9]:?[012345][0-9]$/
    );
  };
  validations.generationTimeCheck = function (val) {
    ...
    return parts.length === 2 &&
      validations.generationTimeValidDate(parts[0]) &&
      validations.generationTimeValidTime(parts[1])
      ? true
      : false;
  };
  ...
  Encryption.prototype.monitor = function (field, node) {
    if (
      typeof field !== "string" ||
      (field !== "number" && field !== "cvc" && field !== "holderName")
    ) {
      throw new Error(
        "invalid fieldname. Expected 'number', 'cvc' or 'holderName', but received '" +
          field +
          "'"
      );
    }
  ...
  var EncryptedForm = function (element, key, options) {
    ...
    options.generationtimeSkipValidation =
      options.generationtimeSkipValidation === true;
